...
| <a name="input_helm_chart_version"></a> [helm\_chart\_version](#input\_helm\_chart\_version) | Version of the Postgresql helm chart that will be deployed. | `string` | `"13.6.1"` | no |
